...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (err === "expired") setError("Your link has expired. Please log in again.");
  }, [searchParams]);
      ...
      <div style={{ maxWidth: "420px", width: "100%" }}>
        ...
        <div style={{ background: "white", borderRadius: "20px", padding: "32px", border: "1px solid #e5e7eb" }}>
          ...
          <p style={{ textAlign: "center", color: "#888", fontSize: "13px" }}>
            No account yet?{" "}
            <a href="/onboarding" style={{ color: "#1a5c38", fontWeight: "600", textDecoration: "none" }}>Start free trial</a>
          </p>
        </div>
      </div>
    </div>
